...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-paper text-ink transition-colors duration-300 dark:bg-neutral-950 dark:text-neutral-50">
        ...
        <div className="grid gap-12 lg:grid-cols-[1.08fr_0.92fr] lg:items-end">
          <motion.div {...fadeIn} className="space-y-8">
            ...
            <div className="space-y-5">
              ...
              <p className="max-w-2xl text-lg leading-8 text-muted dark:text-neutral-300">
                I am {profile.name}, founder of {profile.brand}. I build content, AI-assisted creative systems, social
                media stories, scripts, and remote marketing support for teams that need clear execution.
              </p>
            </div>
          ...
          <motion.div {...fadeIn} transition={{ ...fadeIn.transition, delay: 0.12 }} className="hero-visual">
            <div className="relative overflow-hidden border border-line bg-white dark:border-neutral-800 dark:bg-neutral-900">
              ...
              />
              <div className="absolute bottom-0 left-0 right-0 border-t border-white/50 bg-white/88 p-4 backdrop-blur dark:border-neutral-800 dark:bg-neutral-950/86">
                <div className="flex items-end justify-between gap-4">
                  <div>
                    <p className="text-xs uppercase tracking-[0.22em] text-muted dark:text-neutral-400">Founder</p>
                    <p className="mt-1 text-xl font-semibold">{profile.brand}</p>
                  </div>
                  <div className="text-right">
                    <p className="text-3xl font-semibold text-signal">3</p>
                    <p className="text-xs text-muted dark:text-neutral-400">clients / 3 months</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <StatusPanel title="Content Studio" value="IDEA House" detail="Minimal brand, writing, AI and video support" />
      ...
      <section id="brand" className="border-y border-line bg-white dark:border-neutral-800 dark:bg-neutral-900">
        <div className="section-shell">
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
            <motion.div {...fadeIn}>
              <p className="section-kicker">IDEA House</p>
              <h2 className="mt-4 text-[clamp(2.4rem,5vw,5.6rem)] font-semibold leading-[0.96]">
                A young studio with a focused first season.
              </h2>
            </motion.div>

            <motion.div {...fadeIn} transition={{ ...fadeIn.transition, delay: 0.12 }} className="space-y-6">
              <p className="text-lg leading-8 text-muted dark:text-neutral-300">{profile.brandStory}</p>
              <div className="grid gap-3 sm:grid-cols-3">
                <MetricCard value="3" label="clients accepted" detail="across the first season" />
                <MetricCard value="3 mo" label="founded" detail="new, focused, selective" />
      ...
      <section id="contact" className="section-shell">
        <SectionIntro
          ...
          text="Use the form or direct links below for remote roles, freelance content work, and IDEA House collaborations."
        />
      ...
      <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8" aria-label="Main navigation">
        <a className="flex items-center gap-3" href="#home" onClick={() => setMenuOpen(false)}>
          ...
          <span className="leading-tight">
            <span className="block text-sm font-semibold uppercase tracking-[0.16em]">{profile.brand}</span>
            <span className="block text-xs text-muted dark:text-neutral-400">Pyae Zaw</span>
          </span>
        </a>
